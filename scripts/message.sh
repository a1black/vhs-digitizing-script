...
en_msg[nothing_to_cut]="Cut marks are not set, exit script."
...
en_msg[truncate_started]="Truncate process was successfully started."
## Actions
...
ru_msg[nothing_to_cut]="Завершение работы в связи с отсутствием меток для обрезки файла."
...
ru_msg[truncate_started]="Процесс обрезки видео файла был успешно запущен!"
## Actions
